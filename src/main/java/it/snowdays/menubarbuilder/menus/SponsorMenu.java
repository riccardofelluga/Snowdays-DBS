...
public class SponsorMenu extends Menu {
    ...
    private String firmsQuery = "SELECT s.company, s.cash, s.vat_no, e.name, count(e.vat_no) AS quantity FROM (sponsor s LEFT JOIN edible e ON s.vat_no = e.vat_no) GROUP BY s.company, s.cash, e.name";
